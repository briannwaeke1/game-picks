...
const SignUpPage = () => {
	...
	return (
		<div className='h-full bg-grey-100 w-full py-16 px-4'>
			<div className='flex flex-col items-center justify-center'>
				<h1 className='text-6xl font-bold leading-6 text-black'>
					Game<span className='text-blue-500'>Picks</span>
				</h1>
				<div className='bg-white shadow-xl rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16'>
					<p
						tabIndex={0}
						role='heading'
					...
					<div className='mt-8'>
						<button
							...
							className='focus:ring-2  text-sm font-semibold leading-none text-white focus:outline-none bg-blue-500 border rounded hover:bg-blue-500 py-4 w-full'
						>
							Create my account
						</button>
					</div>
